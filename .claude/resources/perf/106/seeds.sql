...
-- courses, course_schedules는 #104 시드(id 1000001~1024000, 24,000건, 강의당 시간표 3건)를 그대로 쓴다. course.sql은 돌리지 않는다.
...
--
-- 규모 근거: 학년별 인원과 평균 장바구니 수는 실제 추정치(4학년 3,430명 4과목, 3학년 2,733명 6과목,
